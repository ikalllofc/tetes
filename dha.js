...
petik = '```'
fake = 'CREATOR BOT\©ikalllofc '//GANTI NAMA KAMU BEP
ban =[]
...
//------------------< Premium >-------------------
       ...
       case 'buypremium':
       case 'sewabot':
              gopeynya = 'https://telegra.ph/file/b86b529364f7f8274c964.jpg'
              teksnya = `*── 「 PRICE LIST 」 ──*

*SHERLYNN SEWA BOT WA*
FITUR:ANTILINK,WELCOME,ADD,KICK,DEMOTE,DAN MASIH BANYAK LAGI

HARGA PERMANEN:~25k~ PROMO!!! *20k* MINAT? HUBUNGI OWNER`
...
case 'tiktok':
              ...
              imageMsg = (await dha.prepareMessageMedia(fs.readFileSync(`./media/sherlynn.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/sherlynn.jpg`)})).imageMessage
              buttonsMessage = {footerText:'Jangan Lupa Subscribe Yt Sherlynn-Botz\n Helpme tu 1k subscriber', imageMessage: imageMsg,
...
case 'getvn':
      ...
      case 'broadcast':
             ...
             for (let _ of anu) {
             sendMess(_.jid, `*「 PESAN SIARAN Sherlynn-Botz」*\n\n${body.slice(4)}`)
}
             reply('Suksess broadcast')
}
             break
...
//------------------< Lainnya >-------------------
        ...
        case 'info':  // Jangan Di Ubah Plise
               urlinfo = 'https://telegra.ph/file/b86b529364f7f8274c964.jpg'
